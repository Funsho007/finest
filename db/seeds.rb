...
# Debug message to check if categories are being processed
puts "Processing categories: #{categories.inspect}"
...
# Create Pages
Page.find_or_create_by!(title: "Contact", permalink: "contact", content: "<h1>Contact Us</h1><p>Please fill in the form below to contact us.</p><%= render 'contact_form' %>")
Page.find_or_create_by!(title: "About", permalink: "about", content: "<h1>About Us</h1><p>This is the about page content.</p>")

StaticPage.create(title: 'Contact', content: 'Default contact content')
StaticPage.create(title: 'About', content: 'Default about content')

# db/seeds.rb

Category.create(name: 'Lipsticks')
Category.create(name: 'Foundations')

Product.create(name: 'Red Lipstick', description: 'A vibrant red lipstick', price: 19.99, category: Category.find_by(name: 'Lipsticks'))
Product.create(name: 'Matte Foundation', description: 'A matte finish foundation', price: 29.99, category: Category.find_by(name: 'Foundations'))
